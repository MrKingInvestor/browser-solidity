...
function runTests (browser, testData) {
  ...
  .perform((client, done) => {
    contractHelper.testContracts(browser, 'Untitled.sol', sources[0]['browser/Untitled.sol'], ['Ballot'], function () {
      ...
      .pause(500)
      .click('span#tx0x0571a2439ea58bd349dd130afb8aff62a33af14c06de0dbc3928519bdf13ce2e i[class^="caret"]')
      .pause(1000)
      ...
      .perform((client, done) => {
        ...
        browser.testFunction('delegate - transact (not payable)', '0x057d54e2f76f3993078ecf9e1b54a148def4520afc141a182293b3610bd3ce2e',
              `[vm]\nfrom:0xca3...a733c\nto:Ballot.delegate(address) 0x692...77b3a\nvalue:0 wei\ndata:0x5c1...4d2db\nlogs:0\nhash:0x057...3ce2e`,
